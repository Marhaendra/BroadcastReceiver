...
public class NewAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        String clockString = DateFormat.getTimeInstance(DateFormat.SHORT)
                .format(new Date());
        ...
        views.setTextViewText(R.id.appwidget_update,clockString);
        views.setTextViewText(R.id.appwidget_update2,dateString);
